...
void rootlogon() {
    ...
    // Tell the compiler where to look for headers. Use the same kinds of flags that you've seen in the course. Note that paths cannot be relative or use
    // ~
    // gSystem->AddIncludePath("-I/home/einarelen/project/include");
    // gSystem->AddIncludePath("-I/Users/pinar/LU/courses_CSE/MNXB01_cpp/6_projects/MNXB01-ProjectNPT/include");
    // gSystem->AddIncludePath("-I/Users/pinar/LU/courses_CSE/MNXB01_cpp/6_projects/MNXB01-ProjectNPT/src");

    // gSystem->AddIncludePath("-I~/MNXB01-ProjectNPT/include");
    // gSystem->AddIncludePath("-I~/MNXB01-ProjectNPT/src");
    ...
    // If you want to add flags to the linking process, use the gSystem->AddLinkedLibs() function. Use the same kinds of flags that you are
    ...
    gROOT->ProcessLine(".L src/Record.cpp+");
    gROOT->ProcessLine(".L src/Read.cpp+");
    gROOT->ProcessLine(".L src/Analyze.cpp+");
    gROOT->ProcessLine(".L src/Plot.cpp+");
